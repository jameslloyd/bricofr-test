  ...
  var WorldMap = function(params) {
    ...
    $(params.container).delegate('.jvectormap-region', 'mouseover mouseout', function(e){
      var path = e.target,
        ...
        labelShowEvent = $.Event('labelShow.jvectormap') // hide region label,
      ...
      if (e.type == 'mouseover') {
        ...
        map.label.text(mapData.paths[code].name) //region name;
    ...
    if (params.markers) {
      ...
      $(params.container).delegate('.jvectormap-marker', 'click', function(e){
        ...
        $(params.container).trigger('markerClick.jvectormap', [index], map.markers[index].config.name);
      });
    }
  ...
  WorldMap.prototype = {
    ...
    createMarkers: function(markers) {
      var group = this.canvas.createGroup(),
          ...
          point,
          markerConfig,
          defaultConfig = {latLng: [0, 0], r: 3, fill: 'white', stroke: '#505050'};
